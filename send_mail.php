...
try {
    ...
    //Recipients
    $mail->setFrom('youngwallage@gmail.com.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('peternduchi835@gmail.com', 'Joe User');     //Add a recipient (your bae's email address)
